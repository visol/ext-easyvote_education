...
//		'transOrigDiffSourceField' => 'l10n_diffsource',
		...
		'searchFields' => '',
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('easyvote_education') . 'Resources/Public/Icons/tx_easyvoteeducation_domain_model_vote.gif'
	),
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_easyvoteeducation_domain_model_vote.pid=###CURRENT_PID### AND tx_easyvoteeducation_domain_model_vote.sys_language_uid IN (-1,0)',
			),
		),
