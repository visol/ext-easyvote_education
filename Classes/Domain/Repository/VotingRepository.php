...
class VotingRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
    ...
    public function findNextVotingByPanelAndCurrentVoting(
        \Visol\EasyvoteEducation\Domain\Model\Panel $panel,
        \Visol\EasyvoteEducation\Domain\Model\Voting $currentVoting
    ) {
        $query = $this->createQuery();
        $query->matching(
            $query->logicalAnd(
