...
class VotingController extends \Visol\EasyvoteEducation\Controller\AbstractController
{
    ...
    public function newAction(\Visol\EasyvoteEducation\Domain\Model\Panel $panel, $selection = '')
    {
        if ($this->isCurrentUserOwnerOfPanel($panel)) {
            ...
            $newVotingTitle = LocalizationUtility::translate('voting.actions.new.dummyText.newVoting',
            ...
            switch ((int)$selection) {
                case Voting::TYPE_VOTING_YESNOABSTENTION:
                    ...
                    $votingOptionDummyText = LocalizationUtility::translate('voting.actions.new.dummyText.yes',
                        $this->request->getControllerExtensionName());
                    ...
                    $votingOptionDummyText = LocalizationUtility::translate('voting.actions.new.dummyText.no',
                        $this->request->getControllerExtensionName());
                    ...
                    $votingOptionDummyText = LocalizationUtility::translate('voting.actions.new.dummyText.abstention',
                        $this->request->getControllerExtensionName());
    ...
    public function duplicateAction(Voting $voting)
    {
        if ($this->isCurrentUserOwnerOfPanel($voting->getPanel())) {
            ...
            $copyOfText = LocalizationUtility::translate('voting.actions.duplicate.copyOf',
                $this->request->getControllerExtensionName());
