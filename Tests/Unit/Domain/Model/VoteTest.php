...
/**
 * Test case for class \Visol\EasyvoteEducation\Domain\Model\Vote.
 *
...
class VoteTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Visol\EasyvoteEducation\Domain\Model\Vote
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Visol\EasyvoteEducation\Domain\Model\Vote();
	}
